...
import 'package:pet_shop_manager/tools/permission_util.dart';
...
Widget pmGetText(
  ...
  return Text(
    text,
    style: TextStyle(
        color: textColor ?? PMColorUitl.pmGetColor("#454545"),
          ...
          child: Row(
            ...
            children: [
              ...
              TextButton(
                  ...
                  child: pmGetText("保存", textColor: PMColorUitl.mainGreen))
            ],
          ),
        ),
        pmDivider(),
